...
temp = sensor_statistics(
    history,
    "temperature_c",
)

humid = sensor_statistics(
    history,
    "humidity",
)

soil = sensor_statistics(
    history,
    "soil_moisture",
)

light = sensor_statistics(
    history,
    "light_intensity",
)
